    ...
    <Card className="hover:shadow-lg transition-shadow duration-200">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <div>
            {match.moment === "NOW" && (
              <Badge className="bg-green-500 hover:bg-green-600 text-white animate-pulse">AO VIVO</Badge>
            )}
            ...
            {match.moment === "FUTURE" && <Badge className="bg-blue-500 hover:bg-blue-600 text-white">HOJE</Badge>}
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 flex-1 min-w-0">
            ...
            <span className="font-medium text-sm truncate min-w-0">{match.firstContestant.popularName}</span>
          </div>

          <div className="px-3 py-1 bg-muted rounded-md mx-2 flex-shrink-0">
            {match.firstContestant.score !== null && match.secondContestant.score !== null ? (
          ...
          <div className="flex items-center space-x-3 flex-1 justify-end min-w-0">
            <span className="font-medium text-sm truncate text-right min-w-0">
